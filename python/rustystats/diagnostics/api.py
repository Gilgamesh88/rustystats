...
def compute_diagnostics(
    ...
    if hasattr(result, "null_deviance"):
        null_deviance = (
            result.null_deviance() if callable(result.null_deviance) else result.null_deviance
        )
    ...
    if (
        score_test_design_matrix is None
    ...
    warnings = computer.generate_warnings(
        fit_stats_for_warnings, calibration, factors, family=family
    )
